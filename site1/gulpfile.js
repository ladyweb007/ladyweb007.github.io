    ...
    gulp.task('css-libs', ['libs'], function() {
    ...
    gulp.task('build', ['clean', 'img', 'less', 'libs' ,'scripts'], function() {
...
// 	return gulp.src("app/less/main_less.less")
// 		.pipe(less())
// 		.pipe(gulp.dest("app/css"))
// });
